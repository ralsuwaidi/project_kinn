...
bambi_1= """Something warm is nudging against your arm
Its a bit wet
...
You stand up slowly and look around. This place looks familiar you think as you take in your surroundings It looks like you've been sleeping with a couple of baby deers and their mom. It looks like the mom has accepted you as one of her babies. So nice of her.
...
and Bambi follows
It seems like she is attached to you...should you take her with you or keep her safe?
"""

c_bambi_1=["A) Take her with you, she might be a good distraction",
"B) tell her to go back, it's safer that way"]

a_bambi_1=["""As you walk towards the sound a small creature suddenly jumps out of the bushes.
...
bambi_2="""You start to wonder around to dry yourself up and find something to eat. The forest at this side of the river seems to be thinner and more isolated since you are closer to the base of a mountain nearby. \Should you explore the mountains for a vantage point or...
"""

c_bambi_2=["""A) Check the mountain for vantage point""","B) Follow river path around mountain"]

a_bambi_2=["""You walk towards the mountain hoping to gain a vantage point so that you can get your bearings
After walking for what felt like an eternity you finally can see the base of the mountain
There is a big cave that leads to the heart of the mountain. On top of the caves entrance you find three huge crows screeching and pecking at each other. The sight of them frightens you because they looked way bigger than they are supposed to.
...
As soon as you thunk it, you wish you hadnt As you get a glimpse of a carcass being mauled by three furry creatures but those look nothing like bamby thats for sure
Theres no way to go but forward, the path youve come from promises a difficult road for survival
...
arthur_1="""You look through the window to see who might be living in the cottage.
...
c_arthur_1=["A) Check the voice out","B) Leave it alone"]

a_arthur_1=["Walk towards it slowly","""You walk away but it draws you
Something within the voice reeks of power and...loneliness
You decide to investigate even against your better judgement"""]

arthur_2="""As you get closer the voice becomes more intelligible. It sounded very rough like two blocks of stone rubbing against each other. You find the source of the voice hanged on one of the walls.  It appears to be a purple mask of some sorts with two ears poking from its head. It strikes you as odd that there is no magical items in its immediate vicinity.
...
arthur_2_1=""" "WHO THE HELL DARES WALKS INTO MY-" he stops after taking a good look at you.
